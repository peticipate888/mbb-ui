...
__export(index_exports, {
  ...
  cn: () => cn,
  favicon: () => favicon,
  formChecklistDefault: () => formChecklistDefault,
  formChecklistError: () => formChecklistError,
  iconAdBannerClose: () => iconAdBannerClose,
  iconAdd: () => iconAdd,
  iconAddSecondary: () => iconAddSecondary,
  iconApprove: () => iconApprove,
  iconApproveGray: () => iconApproveGray,
  iconArrowDown: () => iconArrowDown,
  iconArrowLeft: () => iconArrowLeft,
  iconArrowLeftSolid: () => iconArrowLeftSolid,
  iconArrowRight: () => iconArrowRight,
  iconArrowStraightRight: () => iconArrowStraightRight,
  iconArrowWhiteLeft: () => iconArrowWhiteLeft,
  iconAttention: () => iconAttention,
  iconAttentionLine: () => iconAttentionLine,
  iconBell: () => iconBell,
  iconBellGray: () => iconBellGray,
  iconBreed: () => iconBreed,
  iconCalender: () => iconCalender,
  iconCheck: () => iconCheck,
  iconCheckbox: () => iconCheckbox,
  iconCircleLeft: () => iconCircleLeft,
  iconCircleRight: () => iconCircleRight,
  iconClose: () => iconClose,
  iconComplete: () => iconComplete,
  iconCreatGray: () => iconCreatGray,
  iconCreate: () => iconCreate,
  iconCreatePrimary: () => iconCreatePrimary,
  iconCredit: () => iconCredit,
  iconDocument: () => iconDocument,
  iconDrag: () => iconDrag,
  iconDropdownArrowDown: () => iconDropdownArrowDown,
  iconEdit: () => iconEdit,
  iconEditGray: () => iconEditGray,
  iconEditOn: () => iconEditOn,
  iconExport: () => iconExport,
  iconExportOrange: () => iconExportOrange,
  iconFeedbackSuscess: () => iconFeedbackSuscess,
  iconFilter: () => iconFilter,
  iconFilterDown: () => iconFilterDown,
  iconFilterGray: () => iconFilterGray,
  iconGoogle: () => iconGoogle,
  iconGoto: () => iconGoto,
  iconGrouping: () => iconGrouping,
  iconGroupingGray: () => iconGroupingGray,
  iconInfo: () => iconInfo,
  iconInfoSolidWarning: () => iconInfoSolidWarning,
  iconInvisible: () => iconInvisible,
  iconLine: () => iconLine,
  iconLinkFail: () => iconLinkFail,
  iconLinkSuccess: () => iconLinkSuccess,
  iconListStyleBigDisc: () => iconListStyleBigDisc,
  iconListStyleBigDiscDisabled: () => iconListStyleBigDiscDisabled,
  iconMail: () => iconMail,
  iconMinus: () => iconMinus,
  iconModalClose: () => iconModalClose,
  iconMore: () => iconMore,
  iconNavbarToggler: () => iconNavbarToggler,
  iconNavbarTogglerClose: () => iconNavbarTogglerClose,
  iconPaginationArrow: () => iconPaginationArrow,
  iconPaginationNext: () => iconPaginationNext,
  iconPaginationPrevious: () => iconPaginationPrevious,
  iconPetBullet: () => iconPetBullet,
  iconPetCardArrow: () => iconPetCardArrow,
  iconPetHand: () => iconPetHand,
  iconPetHandPrimary: () => iconPetHandPrimary,
  iconPhoto: () => iconPhoto,
  iconPhotoClose: () => iconPhotoClose,
  iconPhotoGray: () => iconPhotoGray,
  iconPlanFeaturesPaginationLeft: () => iconPlanFeaturesPaginationLeft,
  iconPlanFeaturesPaginationRight: () => iconPlanFeaturesPaginationRight,
  iconPoint: () => iconPoint,
  iconQaArrow: () => iconQaArrow,
  iconQaSwitchMinus: () => iconQaSwitchMinus,
  iconQaSwitchPlus: () => iconQaSwitchPlus,
  iconReject: () => iconReject,
  iconRejectGray: () => iconRejectGray,
  iconRejectWhite: () => iconRejectWhite,
  iconRequest: () => iconRequest,
  iconRequestGray: () => iconRequestGray,
  iconSearch: () => iconSearch,
  iconSearchGray: () => iconSearchGray,
  iconShipping: () => iconShipping,
  iconSidebarFrontend: () => iconSidebarFrontend,
  iconSidebarHelpCircle: () => iconSidebarHelpCircle,
  iconSidebarMember: () => iconSidebarMember,
  iconSidebarMemberSolid: () => iconSidebarMemberSolid,
  iconSidebarMembers: () => iconSidebarMembers,
  iconSidebarOrders: () => iconSidebarOrders,
  iconSidebarPayment: () => iconSidebarPayment,
  iconSidebarPaymentSolid: () => iconSidebarPaymentSolid,
  iconSidebarPet: () => iconSidebarPet,
  iconSidebarPetSolid: () => iconSidebarPetSolid,
  iconSidebarReferral: () => iconSidebarReferral,
  iconSidebarSystem: () => iconSidebarSystem,
  iconSocialMediaFacebook: () => iconSocialMediaFacebook,
  iconSocialMediaInstagram: () => iconSocialMediaInstagram,
  iconSocialMediaLine: () => iconSocialMediaLine,
  iconSolidAttention: () => iconSolidAttention,
  iconSolidAttentionBlue: () => iconSolidAttentionBlue,
  iconSolidCheckPrimary: () => iconSolidCheckPrimary,
  iconSolidClose: () => iconSolidClose,
  iconSolidInfo: () => iconSolidInfo,
  iconSorterAsc: () => iconSorterAsc,
  iconSorterDesc: () => iconSorterDesc,
  iconSorterReady: () => iconSorterReady,
  iconStarCheck: () => iconStarCheck,
  iconTabControlNext: () => iconTabControlNext,
  iconTabControlPrevious: () => iconTabControlPrevious,
  iconTagCheckOutline: () => iconTagCheckOutline,
  iconTagDisabled: () => iconTagDisabled,
  iconTagDisabledOutline: () => iconTagDisabledOutline,
  iconTagReviewOutline: () => iconTagReviewOutline,
  iconTagSuscess: () => iconTagSuscess,
  iconTicket: () => iconTicket,
  iconTime: () => iconTime,
  iconTrash: () => iconTrash,
  iconTrashRed: () => iconTrashRed,
  iconUnsubscribe: () => iconUnsubscribe,
  iconUpload: () => iconUpload,
  iconVisible: () => iconVisible,
  iconWith: () => iconWith,
  imgAboutHeroMobile: () => imgAboutHeroMobile,
  imgAboutHeroPc: () => imgAboutHeroPc,
  imgAidArcUpBackgroundPad: () => imgAidArcUpBackgroundPad,
  imgAidArcUpBackgroundPc: () => imgAidArcUpBackgroundPc,
  imgAidArcUpBackgroundPhone: () => imgAidArcUpBackgroundPhone,
  imgAidCurveDash: () => imgAidCurveDash,
  imgAidHeroMobile: () => imgAidHeroMobile,
  imgAidHeroPc: () => imgAidHeroPc,
  imgAidNotchBackgroundPad: () => imgAidNotchBackgroundPad,
  imgAidNotchBackgroundPc: () => imgAidNotchBackgroundPc,
  imgAnswer1: () => imgAnswer1,
  imgAnswer2: () => imgAnswer2,
  imgAnswer3: () => imgAnswer3,
  imgArticalDialog: () => imgArticalDialog,
  imgAvatar1: () => imgAvatar1,
  imgAvatar10: () => imgAvatar10,
  imgAvatar11: () => imgAvatar11,
  imgAvatar12: () => imgAvatar12,
  imgAvatar13: () => imgAvatar13,
  imgAvatar2: () => imgAvatar2,
  imgAvatar3: () => imgAvatar3,
  imgAvatar4: () => imgAvatar4,
  imgAvatar5: () => imgAvatar5,
  imgAvatar6: () => imgAvatar6,
  imgAvatar7: () => imgAvatar7,
  imgAvatar8: () => imgAvatar8,
  imgAvatar9: () => imgAvatar9,
  imgBackgroundPad: () => imgBackgroundPad,
  imgBackgroundPc: () => imgBackgroundPc,
  imgBackgroundPhone: () => imgBackgroundPhone,
  imgBgLogo: () => imgBgLogo,
  imgBrand1: () => imgBrand1,
  imgBrand2: () => imgBrand2,
  imgBrand3: () => imgBrand3,
  ...
  imgCancerHeroMobile: () => imgCancerHeroMobile,
  imgCancerHeroPc: () => imgCancerHeroPc,
  imgCardAnswer: () => imgCardAnswer,
  imgCardIcon18year: () => imgCardIcon18year,
  imgCardIconPetsLove: () => imgCardIconPetsLove,
  imgCardQuestion: () => imgCardQuestion,
  imgCatGrayBro: () => imgCatGrayBro,
  imgCatGrayBroPhone: () => imgCatGrayBroPhone,
  imgCenter: () => imgCenter,
  imgControlBtnLeft: () => imgControlBtnLeft,
  imgControlBtnRight: () => imgControlBtnRight,
  imgCorner: () => imgCorner,
  imgDataChecked: () => imgDataChecked,
  imgDataEmpty: () => imgDataEmpty,
  imgDataNoMatch: () => imgDataNoMatch,
  imgDogPurring: () => imgDogPurring,
  imgDogPurringPhone: () => imgDogPurringPhone,
  imgEmptyResult: () => imgEmptyResult,
  imgFailError: () => imgFailError,
  imgFaqHeroMobile: () => imgFaqHeroMobile,
  imgFaqHeroPc: () => imgFaqHeroPc,
  imgFeatureLinkAid: () => imgFeatureLinkAid,
  imgFeatureLinkShipping: () => imgFeatureLinkShipping,
  imgFloatingBtnJoin: () => imgFloatingBtnJoin,
  imgFloatingBtnLine: () => imgFloatingBtnLine,
  imgHeroBgPad: () => imgHeroBgPad,
  imgHeroBgPc: () => imgHeroBgPc,
  imgHeroBgPhone: () => imgHeroBgPhone,
  imgHill: () => imgHill,
  imgIllusDogFetch: () => imgIllusDogFetch,
  imgIllustration: () => imgIllustration,
  imgKv2Image: () => imgKv2Image,
  imgKv2ImageMobile: () => imgKv2ImageMobile,
  imgLeft: () => imgLeft,
  imgLogoSimple: () => imgLogoSimple,
  imgMainImage: () => imgMainImage,
  imgNavChildRadius: () => imgNavChildRadius,
  imgPassStar: () => imgPassStar,
  imgPawsRecruitMobile: () => imgPawsRecruitMobile,
  imgPawsRecruitPc: () => imgPawsRecruitPc,
  imgPdfDownload: () => imgPdfDownload,
  imgPet1: () => imgPet1,
  imgPet2: () => imgPet2,
  imgPet3: () => imgPet3,
  imgPetAvatar: () => imgPetAvatar,
  imgPetCardBg: () => imgPetCardBg,
  imgPetCardBgMobile: () => imgPetCardBgMobile,
  imgPetLeft: () => imgPetLeft,
  imgPetPhoto1: () => imgPetPhoto1,
  imgPetPhoto10: () => imgPetPhoto10,
  imgPetPhoto11: () => imgPetPhoto11,
  imgPetPhoto12: () => imgPetPhoto12,
  imgPetPhoto2: () => imgPetPhoto2,
  imgPetPhoto2x: () => imgPetPhoto2x,
  imgPetPhoto3: () => imgPetPhoto3,
  imgPetPhoto4: () => imgPetPhoto4,
  imgPetPhoto5: () => imgPetPhoto5,
  imgPetPhoto6: () => imgPetPhoto6,
  imgPetPhoto7: () => imgPetPhoto7,
  imgPetPhoto8: () => imgPetPhoto8,
  imgPetPhoto9: () => imgPetPhoto9,
  imgPetRight: () => imgPetRight,
  imgPetStar: () => imgPetStar,
  imgPets: () => imgPets,
  imgPetsMobile: () => imgPetsMobile,
  imgQuestion1: () => imgQuestion1,
  imgQuestion2: () => imgQuestion2,
  imgQuestion3: () => imgQuestion3,
  imgRight: () => imgRight,
  imgStory: () => imgStory,
  imgSubtitleLeft: () => imgSubtitleLeft,
  imgSubtitleRight: () => imgSubtitleRight,
  imgSubtract: () => imgSubtract,
  imgSubtractMb: () => imgSubtractMb,
  imgSuccessCheck: () => imgSuccessCheck,
  imgTermsHeroMobile: () => imgTermsHeroMobile,
  imgTermsHeroPc: () => imgTermsHeroPc,
  imgWaveMobile: () => imgWaveMobile,
  imgWavePc: () => imgWavePc,
  kvArrowLeft: () => kvArrowLeft,
  kvArrowLeftSolid: () => kvArrowLeftSolid,
  kvArrowRight: () => kvArrowRight,
  kvCardAnswer: () => kvCardAnswer,
  kvCardQuestion: () => kvCardQuestion,
  kvControlBtnLeft: () => kvControlBtnLeft,
  kvControlBtnRight: () => kvControlBtnRight,
  kvCorner: () => kvCorner,
  kvIllustration: () => kvIllustration,
  kvPetStar: () => kvPetStar,
  kvSubtract: () => kvSubtract,
  kvSubtractMb: () => kvSubtractMb,
  kvWith: () => kvWith,
  sysError: () => sysError,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("header", { className: "fixed top-0 left-0 right-0 z-[1020]", children: [
    /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("nav", { className: "hidden xl:block py-3", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "mx-auto max-w-[1200px] flex items-center bg-white rounded-pill shadow-card px-6 h-[56px]", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "flex items-center gap-3 shrink-0", children: isLoggedIn ? /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(import_jsx_runtime17.Fragment, { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(import_link.default, { href: "/account", className: "block", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("img", { src: avatarUrl || imgPetAvatar, alt: "\u500B\u4EBA\u982D\u50CF", className: "h-9 w-9 rounded-full object-cover border border-[var(--neutral-300)]" }) })
